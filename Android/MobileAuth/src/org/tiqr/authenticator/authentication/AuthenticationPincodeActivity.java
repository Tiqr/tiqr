...
public class AuthenticationPincodeActivity extends AbstractPincodeActivity {
	 ...
	 * 
	 * This is a Handler, because the actual communication between the device and the server happens in a separate Thread.
	 * This way, using a Handler, we can update the UI Thread.
	 */
