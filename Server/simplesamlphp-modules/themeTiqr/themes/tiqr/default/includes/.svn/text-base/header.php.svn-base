...
?></title>
	...
	<link rel="stylesheet" type="text/css" href="/<?php echo $this->data['baseurlpath']; ?>module.php/themeTiqr/resources/default.css" />	
	<link rel="icon" type="image/icon" href="/<?php echo $this->data['baseurlpath']; ?>module.php/themeTiqr/resources/favicon.ico" />
...
<div id="container">
	...
	<div id="header_wrap">
		...
		<!--<div class="blog_title_wrap"><div class="blog_title">-->
			<h1><a href="https://tiqr.org/" title="Tiqr home page"><span>Tiqr</span></a></h1>
		...
		<div class="topmenu">
			<ul>
				<li class="page_item page-item-7 current_page_item"><a href="#" title="Authentication">Authentication</a></li>
				<li class="rss"><a href="https://tiqr.org/?feed=rss2" title="Subscribe to this blog by RSS">RSS</a></li>
			</ul>
		</div>
	...
	<div id="page">
		...
		<div class="main">
		  ...
		  <div class="post_title post_title_alt">
			<h2 style="text-align: right"><span style="float:left"><a style="text-decoration: none; color: white" href="/<?php echo $this->data['baseurlpath']; ?>"><?php 
